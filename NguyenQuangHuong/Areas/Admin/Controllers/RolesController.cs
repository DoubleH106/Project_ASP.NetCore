...
namespace NguyenQuangHuong.Areas.Admin.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        public RolesController(Project3Nhom2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Roles != null ? 
                          ...
                          Problem("Entity set 'Project3Nhom2Context.Roles'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Project3Nhom2Context.Roles'  is null.");
            }
            var role = await _context.Roles.FindAsync(id);
            if (role != null)
            {
