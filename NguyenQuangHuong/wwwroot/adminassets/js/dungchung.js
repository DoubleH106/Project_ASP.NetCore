	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <a class="fa fa-facebook" href="https://www.facebook.com/Trum.2506" target="_blank"></a>
                <a class="fa fa-twitter" href="https://twitter.com/trum2506" target="_blank"></a>
                <a class="fa fa-google" href="https://mail.google.com/mail/u/0/#inbox" target="_blank"></a>
                <a class="fa fa-youtube" href="https://www.youtube.com/channel/UCLFIGHFyNEomzWAR4mfJbbw" target="_blank"></a>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Trang chủ Trum Store" title="Trang chủ Trum Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Trum Store</a> - All rights reserved © 2023 - Designed by
            <span style="color: #eee; font-weight: bold">Trum Béo</span></p>
    </div>`);
}
        ...
        <section>
            <ul class="flexContain">
                ...
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:0327235336" style="color: #288ad6;">0327235336</a>
                </li>
            </ul>
        </section>
    </div>`);
