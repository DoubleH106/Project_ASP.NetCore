...
namespace NguyenQuangHuong.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Datngay([Bind("BookingDate,EndBookingDate,Price,NumberOfGuards")] ServiceBooking serviceBooking, int? idServicess, string price)
        {
